...
#df = pd.read_csv(arquivo, sep='|', header=None, encoding='latin1', on_bad_lines='skip')

def encontrar_nf_sem_chave():
    arquivo = r'C:\Users\vlsilva\Documents\PYTHON PROJETOS\fiscal\speedfiscal\teste\EFD_1_301_010224_173849 ret_nov.TXT'
    with open(arquivo, 'r', buffering=20000) as f:
            for linha in f:
                ...
                if valores[1] == 'C100' and valores[9] =='':
                    ...
                    if nota in planilha_concatenada.values:
                        print(f'Código: {bloco} - Nota: {nota} - Chave TXT: {chave}  - Chave Planilha: {chave_acesso[planilha_concatenada[planilha_concatenada["Número NF"] == nota].index[0]]}')
